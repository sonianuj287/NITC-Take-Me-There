    ...
    return (
      <View style={styles.container} >
            <Card>
                ...
                <Text></Text>
                <Text></Text>
                <Button title='current location' onPress={()=>{props.navigation.navigate('location')}}/>
            </Card>
            <View style={{flexDirection: 'row',padding:10,paddingLeft:13}}>
                <Button title='saved location' onPress={()=>{props.navigation.navigate('save')}}/>
                <Text>   </Text>
                <Button title='explore campus' onPress={()=>{props.navigation.navigate('explore')}}/>
                <Text>   </Text>
                <Button title = "bus schedule" onPress={() =>{
                         props.navigation.navigate({routeName:'bus'})
                        } }/>
                <Text>   </Text>
                <Button title = "Share Loc" onPress={() =>{
                         props.navigation.navigate({routeName:'share'})
                        } }/>
            </View>            
      </View>
    );
